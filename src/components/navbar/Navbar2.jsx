                ...
                <div className="absolute left-0 z-[9999] hidden w-full rounded-b-3xl bg-white p-2 text-black group-hover:block  ">
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600 w-3/5">
                      Working with your web development team was a pleasure. The communication throughout the project was excellent, and the final result is exactly what we envisioned.
                      </p>
