      ...
      <section className="mx-auto max-w-[1200px] text-white">
        <div className=" grid py-5 md:grid-cols-3">
          <div className=" px-4 py-8 ">
            ...
            <p className="">
            Feel free to reach out to us at any time with your website concerns; we're here to help and ensure your online presence meets your expectations.
            </p>
            <br />
