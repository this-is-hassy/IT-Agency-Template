        ...
        <section className="container flex flex-col items-center justify-center py-10 md:h-[500px] ">
          <div className="grid grid-cols-1 items-center gap-4  md:grid-cols-2">
            ...
            >
              ...
              We've amplified your business website's reach with tailored SEO strategies. Now, expect faster scalability and increased online visibility for optimal growth.
              </p>
              <div>
                <ul className="flex list-inside list-disc flex-col gap-2  md:gap-4">
                  <li className="font-medium">
                  JEST (Efficient Testing)
                  </li>
                  <li className="font-medium">
                  Cypress (End-to-End Testing)
                  </li>
                  <li className="font-medium">  Test Automation (reliable and maintainable code)</li>
                </ul>
              </div>
