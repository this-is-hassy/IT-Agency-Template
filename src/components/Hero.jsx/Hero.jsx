      ...
      <section className="container flex h-[650px] flex-col items-center justify-center md:h-[500px] ">
        <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
          ...
          >
            ...
            <p className="">
            We specialize in crafting comprehensive full-stack websites, seamlessly combining robust back-end functionality with intuitive front-end design. Our expertise ensures a holistic approach to web development, delivering dynamic and user-friendly experiences.
            </p>
